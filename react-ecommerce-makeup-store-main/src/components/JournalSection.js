    ...
    <div className="jsMainParent mt-28">
      <div className="jsLeft">
        ...
        <Link to={`/journal/april`}>
          <button className="readBtn mt-4"> READ THE JOURNAL </button>
        </Link>
      </div>
      ...
      <div className="jsRightText flex flex-row gap-36 relative font-bold mt-4">
        <p>
          APRIL BLOG: PROTECTIVE HAIRCARE <br /> STYLE AND TIPS
        </p>
        <div>
          <Link to={`/store`}>
            <button className="readBtn"> offline </button>
          </Link>
        </div>
      </div>
    </div>
